...
when u see the big picture of how ur simple -- python3 main.py sets off this crazy chain reaction in the machine. that feeling is like understanding the quantum physics. 
